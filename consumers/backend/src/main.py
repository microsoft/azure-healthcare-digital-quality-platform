...
# ---------------------------------------------------------------------------
# Consumers stack: SOAP notes + multi-encounter sample patients
# ---------------------------------------------------------------------------
try:
    ...
    print("✓ Consumers SOAP notes router registered at /api/patients/{id}/soap-notes")
except Exception as e:  # noqa: BLE001
...
try:
    ...
    print("✓ Consumers sample-patients router registered at /api/sample-patients")
except Exception as e:  # noqa: BLE001

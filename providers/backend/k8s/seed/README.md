...
One-off Kubernetes Job that seeds the providers `cosmos-qavfomo7lvk5e`
...
```pwsh
az aks get-credentials -g rg-dq-providers -n aks-qavfomo7lvk5e --overwrite-existing
pwsh ./apply-seed.ps1
...
az identity federated-credential create `
  ...
  --resource-group rg-dq-providers `
